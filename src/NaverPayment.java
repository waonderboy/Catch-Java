...
public class NaverPayment implements Payment{
     ...
     */
    private static final NaverPayment INSTANCE = new NaverPayment();
     ...
     */
    public static NaverPayment getInstance() {
        return NaverPayment.INSTANCE;
    }
